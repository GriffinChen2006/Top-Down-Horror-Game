...
config.hitboxes						= {script.Parent.Parent.Hitbox}		-- As default, HumanoidRootPart is used (NOT recommended to do GetChildren() on AI).
...
config.enragedSightFactor 			= 1.25
config.enragedPenaltyFactor			= 2
config.enragedFOVFactor 			= 1.5
...
config.detectionRange				= 20
config.detectionFOV					= 70		-- In degrees, the detection FOV of the AI. LIMIT: 180 for full 360 degrees.
config.detectionBubble				= 7		-- In studs, if the AI should autodetect a player, regardless of angle, within a range. will be fixed asap
