...
local event = ReplicatedStorage:WaitForChild("BridgeAtmosphere")
...
while true do
	...
	for _, player in Players do
		local dist = getShortestDistance((player.Character or player.CharacterAdded:Wait()):FindFirstChild("HumanoidRootPart").Position, script.Parent, 26)
